    ...
    try:
        ...
        if file_name.lower().endswith('.csv'):
            ...
            try:
                ...
                #else: # Archivo vacío detectado por sniffer
                     #st.error(f"Archivo CSV '{file_name}' parece vacío.")
                     #return None, []
            except Exception: pass # Usar default sep
        ...
        # --- Procesamiento común post-lectura ---
        if df is not None:
            if df.empty:
